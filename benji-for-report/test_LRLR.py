...
def testmydat():
    for filepath in other_rec_data_names:

        # SESSION_FOLDER_PATH = f"recorded_data/20250524_033637_296315"
        SESSION_FOLDER_PATH = f"../recorded_data/{filepath}"
        print("\n","=="*50)
        print(f"Attempting to load data from: {SESSION_FOLDER_PATH}")
        # SESSION_FOLDER_PATH = f"../recorded_data/v2_LRLR_once_7_closed"
        # SESSION_FOLDER_PATH = f"../recorded_data/{other_rec_data_names[9]}"
